...
func (h *GatewayHandler) Usage(c *gin.Context) {
	...
	h.usageUnrestricted(c, apiKey, usageData, modelStats)
}
...
func (h *GatewayHandler) usageUnrestricted(c *gin.Context, apiKey *service.APIKey, usageData gin.H, modelStats any) {
	// 订阅模式
