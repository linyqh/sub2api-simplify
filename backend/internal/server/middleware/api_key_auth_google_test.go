...
func TestApiKeyAuthWithSubscriptionGoogle_RequiresSubscription(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	require.Equal(t, "Active subscription is required for this group", resp.Error.Message)
...
func TestApiKeyAuthWithSubscriptionGoogle_TouchesLastUsedWithActiveSubscription(t *testing.T) {
	gin.SetMode(gin.TestMode)
