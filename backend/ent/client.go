...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.APIKey, c.Account, c.AccountGroup, c.ErrorPassthroughRule, c.Group,
		c.IdempotencyRecord, c.Proxy, c.SecuritySecret, c.Setting, c.SubscriptionPlan,
...
type (
	hooks struct {
		APIKey, Account, AccountGroup, ErrorPassthroughRule, Group, IdempotencyRecord,
		Proxy, SecuritySecret, Setting, SubscriptionPlan, TLSFingerprintProfile,
