  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        compactModeDesc:
          '控制本账号在 /responses/compact 调度中的参与方式。自动模式跟随探测结果；强制开启会允许参与调度；强制关闭会排除该账号。',
        compactModeAuto: '自动',
        compactModeForceOn: '强制开启',
        compactModeForceOff: '强制关闭',
        compactModelMapping: 'Compact 专属模型映射',
        compactModelMappingDesc:
          '仅在 /responses/compact 请求中生效。当上游 compact 端点需要特殊模型名时使用。',
      ...
      testMode: '测试模式',
      testModeDefault: '标准 Responses',
      testModeCompact: 'Compact 探测',
      compactTestHint: 'Compact 探测会请求 /responses/compact，并把账号 compact 支持状态写回账号配置。',
      openaiCompactProbeMode: '模式：OpenAI Compact 探测',
      testModel: '测试模型',
      testPrompt: '提示词："hi"',
