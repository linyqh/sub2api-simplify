...
const PREFETCH_ADJACENCY: Record<string, string[]> = {
  ...
  '/admin/accounts': ['/admin/proxies', '/admin/users'],
  '/admin/proxies': ['/admin/accounts', '/admin/usage'],
  '/admin/users': ['/admin/groups', '/admin/dashboard'],
  '/admin/groups': ['/admin/subscriptions', '/admin/users'],
  '/admin/subscriptions': ['/admin/groups', '/admin/usage'],
  // User routes
  '/dashboard': ['/keys', '/usage'],
  '/keys': ['/dashboard', '/usage'],
  '/usage': ['/keys', '/subscriptions'],
  '/subscriptions': ['/usage', '/profile'],
