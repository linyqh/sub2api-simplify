...
| `/subscriptions` | SubscriptionsView | Subscription status and quotas |
...
| `/admin/usage`     | AdminUsageView     | Usage and statistics            |
| `/admin/settings`  | AdminSettingsView  | Core system settings            |
